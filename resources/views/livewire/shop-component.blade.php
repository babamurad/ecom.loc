@section('title', 'Shop')
@php use App\Http\Livewire\ShopComponen; @endphp
<div>
    <style>
        .wishlisted{
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="row product-grid-3">
                                ...
                                @foreach($products as $product)
                                    <div class="col-lg-4 col-md-4 col-6 col-sm-6 pb-2">
                                        <div class="product-cart-wrap mb-30 h-100">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <div class="rating-result" title="{{ round($product->rating*20, 2) }}%">
                                            <span>

                                                <span>{{ round($product->rating*20, 2) }}% </span>
                                            </span>
                                                </div>
                                                <div class="product-price">
                                                    <span>${{ $product->regular_price }} </span>
{{--                                                    <span class="old-price">$245.8</span>--}}
{{--                                                    <br><span>{{round(!$product->reviews->count()==0 ? $product->reviews->sum('rating')/$product->reviews->count() : 0, 2) }}</span>--}}
                                                </div>
                                    ...
                                    <div class="price-filter-inner">
                                        ...
                                        <div class="price_slider_amount">
                                            <div class="label-input">
                                                <span>Range:</span><span class="text-info"><strong>${{ $min_value }}</strong></span> - <span id="maxp" class="text-info"><strong>${{ $max_value }}</strong></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
