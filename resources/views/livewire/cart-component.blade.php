        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="{{ route('shop') }}">Shop S</a>
                    <span></span> <a href="{{ route('shop.cart') }}">Your Cart</a>
                </div>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" data-title="Stock">
                                        <div class="detail-qty border radius  m-auto">
                                            <a href="#" class="qty-down" wire:click.prevent="decreaseQuantity('{{ $item->rowId }}', {{ $item->qty }})"><i class="fi-rs-angle-small-down"></i></a>
                                            <span class="qty-val">{{$item->qty}}</span>
                                            <a href="#" class="qty-up" wire:click.prevent="increaseQuantity('{{ $item->rowId }}', {{ $item->qty }})"><i class="fi-rs-angle-small-up"></i></a>
                                        </div>
                                    </td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td class="cart_total_amount"><span class="font-lg fw-900 text-brand">${{ \Gloudemans\Shoppingcart\Facades\Cart::instance('cart')->subtotal() }}</span></td>
                                            </tr>
                                            <tr>
                                                <td class="cart_total_label">Tax - 10%</td>
                                                <td class="cart_total_amount"><span class="font-lg fw-900 text-brand">${{ \Gloudemans\Shoppingcart\Facades\Cart::instance('cart')->tax() }}</span></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="cart_total_amount"><strong><span class="font-xl fw-900 text-brand">${{ \Gloudemans\Shoppingcart\Facades\Cart::instance('cart')->total() }}</span></strong></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <a  class="btn" wire:click.prevent="checkout()"><i class="fi-rs-box-alt mr-10"></i> Proceed To CheckOut</a>
                                </div>
                            </div>
                        </div>
                    </div>
