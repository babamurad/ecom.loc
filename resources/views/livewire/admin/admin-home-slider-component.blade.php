@section('title', 'Admin Home Slider')
<div>
    <main class="main">
                                ...
                                <table class="table-striped">
                                    ...
                                    @foreach($slides as $slide)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admin.home.slide.edit', ['slide_id'=>$slide->id])}}" class="btn btn-sm btn-secondary float-left mr-2">Edit {{ $slide->id }}</a>
                                                <a href="#" class="btn btn-sm btn-danger" onclick="deleteConfirmation({{ $slide->id }})">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
