                                ...
                                <table class="table-striped">
                                    ...
                                    @foreach($categories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.category.edit', ['category_id' => $category->id]) }}" class="btn btn-sm btn-secondary float-left mr-2">Edit</a>
                                                <a href="#" class="btn btn-sm btn-danger" onclick="deleteConfirmation({{ $category->id }})">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
