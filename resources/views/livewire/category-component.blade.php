@section('title', ucfirst($category_name))
                        ...
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                @foreach($categories as $category)
                                    <li><a href="{{ route('product.category', $category->slug) }}">{{ ucfirst($category->name) }}<span class="badge badge-danger ml-5">{{ $category->products->count() }}</span></a></li>
                                @endforeach
                            </ul>
                        </div>
                        <!-- Fillter By Price -->
